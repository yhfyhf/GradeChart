function divideByTime(course) {  // divide courses into groups according to their time 
	...
	var dataPoints = "var timeDataPoints = " + "[" + 
						   "{ label: \"2011 Fall\", y: " + down2011Average + " }," +
						   "{ label: \"2012 Spring\", y: " + up2012Average + " }," +
						   "{ label: \"2012 Fall\", y: " + down2012Average + " }," +
						   "{ label: \"2013 Spring\", y: " + up2013Average + " }," +
						   "{ label: \"2013 Fall\", y: " + down2013Average + " }"  + "]";
						   "{ label: \"2013 Fall\", y: " + down2013Average + " }" + "]";
	return dataPoints;
}
